...
let initWebRoutes = (app) => {
  ...
  router.post(
    "/api/save-info-subject",
    subjectController.handleSaveInfoSubject
  );
  router.get("/api/get-detail-subject", subjectController.getDetailSubject);
  router.get(
    "/api/get-extra-info-subject",
    subjectController.getExtraInfoSubject
  );

  router.get(
    "/api/get-detail-subject-for-modal",
    subjectController.getDetailSubjectForMoldal
  );

  // subject schedule
  router.post(
    "/api/create-subject-schedule",
    subjectController.handleCreateSubjectSchedule
  );
  router.get(
    "/api/get-subject-schedule-by-month",
    subjectController.getCheduleByMonth
  );

  // student register subject
  router.post(
    "/api/student-register-subject",
    studentController.studentRegisterSubject
  );
  router.post(
    "/api/verify-register-subject",
    studentController.verifyRegisterSubjects
  );

  // schedule manage
  router.get(
    "/api/get-list-student-register-lecturers",
    studentController.getListRegisterLecturers
  );

  router.post(
    "/api/sent-email-for-student",
    studentController.sentEmailForStudent
  );

  router.get(
    "/api/get-history-subject-register-for-student",
    studentController.getHistorySchedule
  );
